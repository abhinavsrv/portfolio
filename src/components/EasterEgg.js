...
const EasterEgg = () => {
    ...
    return (_jsxs("div", { className: "easter-egg-page", children: [_jsxs("div", { className: "easter-egg-header", children: [_jsx("h1", { children: "Secret Gallery" }), _jsx("p", { children: "You found the hidden collection! Enjoy these special moments." })] }), _jsx("div", { className: "easter-egg-gallery", children: images.map((image, index) => (_jsx("div", { className: "gallery-item", onClick: () => openLightbox(image), children: _jsx("img", { src: image, alt: `Easter egg ${index + 1}` }) }, index))) }), _jsx("div", { className: "back-link", children: _jsx(Link, { to: "/", className: "project-link-button", children: "Back to Home" }) }), selectedImage && (_jsx("div", { className: "lightbox", onClick: closeLightbox, children: _jsxs("div", { className: "lightbox-content", onClick: (e) => e.stopPropagation(), children: [_jsx("button", { className: "close-button", onClick: closeLightbox, children: "\u00D7" }), _jsx("img", { src: selectedImage, alt: "Enlarged view" })] }) }))] }));
};
